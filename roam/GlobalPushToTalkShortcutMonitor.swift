...
final class GlobalPushToTalkShortcutMonitor: ObservableObject {
    ...
    /// Fires when the user presses Escape while the push-to-talk shortcut is held —
    /// i.e. "abort this interaction."
    ...
    private func handleGlobalEventTap(
        ...
        // Escape while the shortcut is held → cancel the in-progress interaction.
        if eventType == .keyDown, eventKeyCode == Self.escapeKeyCode, isShortcutCurrentlyPressed {
